...
use Modules\System\Menu\Models\InstallModel;
...
class InstallController
{
    public function install(): bool
    {
        ...
        if (!(new \Modules\System\Menu\Libraries\Menu\MenuInstaller())->install()) { return false; }
    ...
    public function uninstall(): bool
    {
        ...
        return (new \Modules\System\Menu\Libraries\Menu\MenuInstaller())->uninstall();
    }
